...
var banner = [
  "xformjs - Xformation JavaScript library v" + packageJson.version,
...
var dts_banner = [
  "Type definitions for Xformation JavaScript library v" + packageJson.version,
  "Copyright (c) 2006-2019 Synectiks Inc  - http://synectiks.com/",
...
module.exports = function(options) {
  ...
  var packagePath = "./packages/xform-" + options.platform + "/";
  var extractCSS = new ExtractTextPlugin({
    filename:
      packagePath +
      (options.buildType === "prod" ? "xform.min.css" : "xform.css")
  });
  ...
  var percentage_handler = function handler(percentage, msg) {
    if (0 === percentage) {
      ...
      if (options.buildType === "prod") {
        dts.bundle({
          name: "../../xform." + options.platformPrefix,
        ...
        if (options.platform === "vue") {
          replace(
            {
              files: packagePath + "xform.vue.d.ts",
          ...
          fs
            .createReadStream(packagePath + "xform.vue.js")
            .pipe(fs.createWriteStream(packagePath + "xform-vue.js"));
          fs
            .createReadStream(packagePath + "xform.vue.min.js")
            .pipe(fs.createWriteStream(packagePath + "xform-vue.min.js"));
        }
  ...
  var mainFile =
    options.platform === "vue"
      ? "xform-vue.js"
      : "xform." + options.platformPrefix + ".js";
  var packagePlatformJson = {
    name: "xform-" + options.platform,
    version: packageJson.version,
    description:
      "xform.js is a JavaScript  Library used across xformation platform ",
    keywords: ["xformation", "JavaScript", "Bootstrap", "Library"].concat(
      platformOptions[options.platform].keywords
    ),
    homepage: "https://xformjs.io/",
    license: "Apache 2.0",
    files: [
      "xform.css",
      "xform.min.css",
      "xform." + options.platformPrefix + ".d.ts",
      "xform." + options.platformPrefix + ".js",
      "xform." + options.platformPrefix + ".min.js"
    ],
    main: mainFile,
    repository: {
      type: "git",
      url: "https://github.com/xformation/xformjs.git"
    },
    typings: "xform." + options.platformPrefix + ".d.ts"
  };
  ...
  config.entry[
    "xform." + (options.platform == "knockout" ? "ko" : options.platform)
